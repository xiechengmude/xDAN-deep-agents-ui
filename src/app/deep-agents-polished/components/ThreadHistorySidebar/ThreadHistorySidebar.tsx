...
export const ThreadHistorySidebar = React.memo<ThreadHistorySidebarProps>(({ open, setOpen, currentThreadId, onThreadSelect}) => {
    ...
    try {
      ...
      const threadList: Thread[] = response.map((thread: any) => {
        ...
        try {
          ...
          console.warn(`Failed to get first message for thread ${thread.thread_id}:`, error)
        }
        return {
          id: thread.thread_id,
